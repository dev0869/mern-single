...
const DropdownComponent = ({ data }) => {
  ...
  const handleStateChange = (event) => {
    ...
    formik.setFieldValue("selectedState", selectedState);
    formik.setFieldValue("selectedDistrict", ""); // Reset selected district when state changes
  };
    ...
    <form onSubmit={formik.handleSubmit}>
      ...
      >
        ...
        {formik.values.selectedState &&
          districtsByState[formik.values.selectedState].map(
            (district, index) => (
